    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card border border-dark">
                <div class="card-header p-3 mb-2 text-dark"><h5><i class="fa fa-file" aria-hidden="true"></i> {{ __('New Department/Sector') }}</h5></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('department.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="category_id" id="category_id" autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="au_id" id="au_id" autofocus required>
                                    ...
                                    @foreach ($au as $data)
                                    <option value="{{ $data->au_id }}">{{ ucfirst($data->au_name) }}</option>
                                    @endforeach
                                </select>
                                    @error('au_id')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input id="department_id" type="text" class="form-control" name="department_id" value="{{ old('department_id') }}" required autocomplete="false" placeholder="ID" maxlength="4">
                                @error('department_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                            <input id="code" type="text" class="form-control" name="code" value="{{ old('code') }}" required autocomplete="code" placeholder="Code" maxlength="6">
                                @error('code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                            <input id="department_name" type="text" class="form-control" name="department_name" value="{{ old('department_name') }}" required autocomplete="false" placeholder="Department/Sector Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                            <input id="accnoid" type="text" class="form-control" name="accnoid" value="{{ old('accnoid') }}" required autocomplete="false" placeholder="Acc.No.ID" maxlength="20">
                                @error('accnoid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
